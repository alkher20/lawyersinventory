	...
	<div class="pb50 cpt2-category">
		...
		<div class="row">
			...
			<h2 class="home-title" style="text-align: center;"><strong>
				 ...
				 <?php echo (isset($falcons_option_data['falcons-header-lawyer_categories'])? $falcons_option_data['falcons-header-lawyer_categories']: ucfirst($directory_url_2).' Categories');?>
