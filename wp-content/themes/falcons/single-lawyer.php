			...
			<div class="col-md-9 col-md-push-3">
					...
					<div class="clearfix content">
						...
						<div class="conten-desc">
							<?php $term_obj_list = get_the_terms( get_the_ID(), 'lawyers-category' );
							if(!empty($term_obj_list)) {
								foreach($term_obj_list as $term_lawyer) { ?>							
									<a href="<?php echo $term_link = get_term_link( $term_lawyer ); ?>">
										<?php echo $term_lawyer->name; ?>
									</a><br>
							<?php }
							} ?>
						</div>
